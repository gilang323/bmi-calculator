  ...
  return (
    <div className='container'>
      <div className='row center'>
        <h1 className='white-text'> Kalkulator BMI </h1>
      </div>
      <div className='row'>
            ...
            <div className='data-container row'>
              {state.length > 0 ? (
                <>
                  ...
                  <div className='center white-text'>Data Tidak Tersedia</div>
                )}
            </div>
          </div>
                      <div className='center'>
                      <button className='calculate-btn' onClick={handleClearData}>
              Clear Data
            </button>
          </div>
        </div>
